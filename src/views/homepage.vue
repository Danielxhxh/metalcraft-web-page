<template>
  <div class="main">
    ...
    <div class="carousel-designs">
      ...
      <img src="/images/door.png" alt="door design" />
      <img src="/images/fence.png" alt="fence design" />
    </div>
...
.carousel-designs > img:hover {
  transform: scale(1.3); /* make the hovered image larger */
  z-index: 1;
}
